...
Em algum momento, não lembro quando, comecei a procurar por algo que "corrigisse" esse problema para mim.
Acho que **li** em algum lugar que um Desenvolvedor Sênior geralmente tinha essas habilidades:
...
> Simplificando, um linter é uma ferramenta que verifica programaticamente seu código com o objetivo de encontrar problemas que podem levar a bugs ou inconsistências na saúde e estilo do código. Alguns podem até ajudá-lo a corrigi-los!
...
Então por que [não usaríamos](https://engineering.hexacta.com/why-arent-you-using-prettier-4fe0a77713e8) isso?
...
- Linters
  - [ESLint](https://eslint.org/) - [(Coisas úteis](https://github.com/dustinspecker/awesome-eslint))
  - [Stylelint](https://stylelint.io/) - [(Coisas úteis](https://github.com/stylelint/awesome-stylelint))
- Formatters
  - [Prettier](https://prettier.io/)

E como bônus, aqui está minha [configuração](https://github.com/gu-does-git/configs).

---

Se você está no mesmo lugar em que eu estava, quando pensava _"O que devo aprender para ser um desenvolvedor melhor?"_, **aqui vai meu conselho para você**:
...
<abbr title="Valeu Emi e Mi ❤️">Obrigado</abbr> por ler até o final! ❤️
